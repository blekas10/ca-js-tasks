...
console.groupCollapsed("WHILE");
{
  ...
  console.groupEnd();
  console.groupCollapsed(
    "8. Sukurkite ciklą kuris atspausdintų nuo 2 iki -3. Naudojant >"
  );
  {
    let i = 2;
    while (i > -4) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "9. Sukurkite ciklą kuris atspausdintų nuo -5 iki -10. Naudojant >"
  );
  {
    let i = -5;
    while (i > -11) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "10. Sukurkite ciklą kuris atspausdintų nuo 2 iki 1. Naudojant >"
  );
  {
    let i = 2;
    while (i > 0) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "11. Sukurkite ciklą kuris atspausdintų nuo 2 iki -3. Naudojant >="
  );
  {
    let i = 2;
    while (i >= -3) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "12. Sukurkite ciklą kuris atspausdintų nuo -5 iki -10. Naudojant >="
  );
  {
    let i = -5;
    while (i >= -10) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "13. Sukurkite ciklą kuris atspausdintų nuo 2 iki 1. Naudojant >="
  );
  {
    let i = 2;
    while (i >= 1) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "31. Atspausdinkite <numbers> masyvo kas antrą elementą iš dešinės, pradedant prieš paskutiniu"
  );
  {
    let i = numbers.length - 2;
    while (i >= 0) {
...
console.groupCollapsed("FOR");
{
  ...
  {
    for (let i = 0; i < 5; i++) {
      console.log(i + 1, "Sveikas Pasauli");
    }
  }
  console.groupEnd();
  console.groupCollapsed(
