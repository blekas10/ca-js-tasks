...
const car1 = new Automobilis("Tesla", "s", 12000);
const car2 = new Automobilis("Vw", "passat", 7000);
const car3 = new Automobilis("Toyota", "CRV", 4000);

const allCars = [car1, car2, car3];
console.log(allCars);

console.group("1 uzduotis");
{
}
console.groupEnd();
console.log();

console.group("2 uzduotis");
{
}
console.groupEnd();
console.log();
console.group("3 uzduotis");
{
  console.log(allCars);
}
console.groupEnd();
console.log();
console.group("4 uzduotis");
{
  console.group("Modelis");
  console.log(car1.model);
  console.log(car2.model);
  console.log(car3.model);
  console.groupEnd();

  console.group("Brandas");
  console.log(car1.brand);
