...
{
  const studentsIT = students.filter(
    (item) => item.faculty === "Informatikos fakultetas"
  );
...
{
  const studentsChem = students.filter(
    (item) => item.faculty === "Chemijos fakultetas"
  );
...
{
  const studentsEngineer = students.filter(
    (item) => item.faculty === "Elektros ir elektronikos fakultetas"
  );
...
);
{
  students.forEach((student) => {
    ...
    student.averageMark = totalMarks / totalCredits;
